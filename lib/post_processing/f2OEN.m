function f2OEN
    ...
    DataPlotting = 0; % Do u want to plot raw data? [Y:1/N:0]
...
%     file_name = '4.4.[NH3];[NO2]=5;1_[O2]=31.25uM+93.75uM.xlsx';
    % Only v3
%     file_name = '1.4.[NH3];[NO2]=1;0_[O2]=93.75uM.xlsx';
%     file_name = '2.4.[NH3];[NO2]=1;1_[O2]=93.75uM.xlsx';
%     file_name = '3.4.[NH3];[NO2]=1.33;1_[O2]=93.75uM.xlsx';
%     file_name = 'data_2OEN.xlsx';
    ...
    if r0 == rmax && c0 == cmax        
        ...
        for i = 1:nSpecies
          for j = 1:nSpecies
              ...
              pY = 0.16;
              FS = 10;
              text(i+0.5+pX, nSpecies-(j-1)+pY, EI_val(j,i), 'HorizontalAlignment', 'center', 'FontSize', FS, 'FontWeight', 'bold')
          end
        end
